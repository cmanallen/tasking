...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column('tasks_task', 'project',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['projects.Project'], blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        'tasks.task': {
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'user_task': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['auth.User']", 'through': "orm['tasks.UserTask']"})
        },
        'tasks.usertask': {
