...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('tasks_attachment', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=3, to=orm['users.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Attachment.user'
        db.delete_column('tasks_attachment', 'user_id')
    ...
    models = {
        ...
        'tasks.task': {
            ...
            'project': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'blank': 'True', 'to': "orm['projects.Project']", 'default': 'None'}),
            'status': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'task_type': ('django.db.models.fields.IntegerField', [], {}),
            'team': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'blank': 'True', 'to': "orm['teams.Team']", 'default': 'None'}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
