...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('users_user', 'avatar', self.gf('django.db.models.fields.files.ImageField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'User.avatar'
        db.alter_column('users_user', 'avatar', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))
    ...
    models = {
        ...
        'users.user': {
            ...
            'avatar': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'default': "'images/default-avatar.jpg'"}),
